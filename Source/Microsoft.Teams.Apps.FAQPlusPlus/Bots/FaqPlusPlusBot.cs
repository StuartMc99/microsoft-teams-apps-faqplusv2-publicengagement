    ...
    public class FaqPlusPlusBot : TeamsActivityHandler
    {
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                {
                    this.logger.LogInformation($"STU Unexpected tenant id {turnContext?.Activity.Conversation.TenantId}", SeverityLevel.Warning);
        ...
        {
            return true; // turnContext.Activity.Conversation.TenantId == this.options.TenantId;
        }
